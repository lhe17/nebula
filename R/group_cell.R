...
#'
#' @name group_cell
#' @title Group cells according to subject IDs
#' @description Reorders the count matrix, subject IDs, predictors, and offset factors so that cells are grouped by subject ID. If cells are already grouped, returns NULL.
#'
